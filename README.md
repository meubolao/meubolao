...
> O projeto "Meu Bolão" se fundamenta em um aplicativo que será responsivo, podendo ser aberto em qualquer aparelho e tem como intuito facilitar as interações envolvendo jogos de apostas, e entreter os usuários durante premiações, e outros eventos, gerando um clima de competição saudavel. Surgiu como uma forma de agilizar os jogos de apostas já existentes, a fim de trazer mais praticidade e organização. O projeto não possui fins lucrativos, e qualquer tipo de envolvimento com bens financeiros é de total responsabilidade dos usuários.
...
Contará com um sistema de registro e de login, onde o usuário poderá criar uma conta contendo Nome, E-mail, e Senha, tendo que concordar com um termo de compromisso que garante que caso o usuario deseje relacionar bens financeiros com as apostas, será de livre e espontanea vontade, e sem envolvimento do aplicativo. No ínicio, o usuário terá a opção de se logar criando uma conta dentro do sistema, ou então, sincronizando sua conta do facebook. Após se logar, o sistema ira abrir um espaço com 2 abas: Uma contendo as informações de seu perfil, outra contendo as informações das salas do sistema, e contendo as informações do perfil de outros usuários do sistema.
...
A aba geral: Na aba geral, o usuário poderá ver as informações das salas disponíveis no sistema, abrir uma nova sala de apostas, a sala atual em que ele está, e a lista de jogadores, organizada em um ranking de acordo com o level, contando com a opção para ver onde o próprio usuario se encontra no ranking, e dizendo se os jogadores estão ou nao estão online.   

As salas: As salas são os ambientes onde as apostas de fato acontecem, elas possuem os seguintes atributos: Nome, Publico/Privada, senha (se for privada), categorias, membros, tempo de duração, inicio da premiação, data de premiação, e foto. Nas categorias, haverão opções de categorias (melhor diretor,  pre-definidas e a possibilidade de criar novas categorias para o criador da sala durante o ato de cria-la, dentro das categorias, o criador deverá colocar as opções possíveis de apostas. Todos os atributos serão determinados pelo criador. Dentro do ambiente da sala, o criador terá a opção de adicionar mais jogadores (estes tem que estar em sua lista de amigos), apagar a sala, e não poderá fazer apostas. Os jogadores comuns que estão na sala, poderão apostar ou sair da sala. Todos jogadores (incluindo o dono), terão disponiveis, um bate-papo dentro da sala para que possam conversar, o tempo restante de apostas, e a opção de ver as apostas atuais. O usuário terá permissao para participar de apenas uma sala por vez. Assim que as apostas em uma sala que ele participa se encerram (isto é, quado o tempo limite se encerra), ele receberá uma notificação de que as apostas na sala se encerraram, e quem foi o vencedor. Além disso, ele será premiado com exp de acordo com sua colocação em acertos dentro da sala.

Exp: A experiencia é dada ao usuário de acordo com a quantidade de acertos que faz em uma sala de apostas em relação ao numero de acertos do que mais acertou, caso o jogador seja quem mais acertou, ele ganhará uma quantia pre definida de 10exp, a cada level atingido, serão necessarios +2xp do necessario do level anterior para atingir o próximo lével.
